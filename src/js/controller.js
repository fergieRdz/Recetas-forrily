...
const getRecipeDetails = function (recipe) {
...
const getRecipeIngredients = function (recipe) {
  return `<div class="recipe__ingredients">
          <h2 class="heading--2">Recipe ingredients</h2>
          <ul class="recipe__ingredient-list">
            ${
              recipe.ingredients.map(ing => getRecipeIngredient(ing))
              .join('')
            }
          </ul>
        </div>`;
}
const getRecipeIngredient = function (ingredient) {
